...
public class FollowingAdapter extends RecyclerView.Adapter<FollowingAdapter.Holder> {
    ...
    public FollowingAdapter(ArrayList<InputBean> arrayList) { //click
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        holder.txt_login.setText(arrayList.get(position).getloging_following());
        Glide.with(view.getContext())
                .load(arrayList.get(position).gettxt_avatar_following())
